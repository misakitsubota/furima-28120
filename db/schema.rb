...
ActiveRecord::Schema.define(version: 2020_11_29_051633) do
  ...
  create_table "buyer_sending_destinations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
